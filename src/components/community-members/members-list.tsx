                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                <div className='cursor-pointer' style={{ textShadow: '2px 2px 8px rgba(0,0,0,0.7)' }}>
                                    <h2 className="text-lg font-bold md:text-3xl bg-clip-text text-transparent bg-gradient-to-r from-yellow-300 to-orange-500 animate-text-shine">Admin</h2>
                                    <p className="text-xl font-black md:text-4xl bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-400 animate-text-shine [animation-delay:0.5s]">Harsh</p>
                                </div>
                            </PopoverTrigger>
                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                <div className='text-right cursor-pointer' style={{ textShadow: '2px 2px 8px rgba(0,0,0,0.7)' }}>
                                    <h2 className="text-lg font-bold md:text-3xl bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-blue-500 animate-text-shine [animation-delay:0.2s]">Co-Admin</h2>
                                    <p className="text-xl font-black md:text-4xl bg-clip-text text-transparent bg-gradient-to-r from-lime-300 to-green-500 animate-text-shine [animation-delay:0.7s]">Atrik</p>
                                </div>
                            </PopoverTrigger>
                            <PopoverContent className='w-80'>
