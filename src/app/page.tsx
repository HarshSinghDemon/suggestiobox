...
export default function Home() {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] text-center px-4 bg-background text-foreground overflow-x-hidden">
        <WavyBackground 
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-arcade tracking-tighter leading-relaxed [text-shadow:0_2px_hsl(45_100%_50%/0.6),0_4px_hsl(35_100%_50%/0.5),0_6px_hsl(25_100%_50%/0.4),0_8px_hsl(15_100%_50%/0.3),0_10px_15px_hsl(260_80%_40%/0.2)]">
            ...
            <div className="flex flex-col items-center justify-center w-full gap-4">
              <div className="flex flex-col items-center w-full gap-4 sm:flex-row sm:justify-center">
                <Button asChild size="lg" className="w-full px-8 py-6 text-lg transition-all duration-300 rounded-full sm:w-auto shadow-lg bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-primary/30 hover:scale-105">
                    <Link href="/suggestions/new" prefetch={true}>
                        Give a Suggestion
                        <ChevronRight className="w-6 h-6 ml-2" />
                    </Link>
                </Button>
                <Button asChild size="lg" variant="secondary" className="w-full px-8 py-6 text-lg transition-all duration-300 rounded-full sm:w-auto shadow-lg hover:shadow-muted/30 hover:scale-105">
            ...
            <div className="pt-8">
              <p className="text-sm text-foreground/60 font-arcade">
                  Made with <span className='inline-block text-red-500 animate-heartbeat'>❤️</span> by 5B
              </p>
            </div>
          </div>
        </WavyBackground>
