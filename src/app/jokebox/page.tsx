...
import { RequestForm } from '@/components/jokebox/request-form';
...
const JokeboxPageContent = () => {
    ...
    const currentSong = useMemo(() => requests?.[0], [requests]);
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-2 space-y-8">
                <Card>
                    ...
                    <CardContent>
                        <JokeboxPlayer song={currentSong} />
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader>
                        <CardTitle>Request a Song</CardTitle>
                        <CardDescription>Search for a song on YouTube and add it to the queue.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <RequestForm />
                    </CardContent>
