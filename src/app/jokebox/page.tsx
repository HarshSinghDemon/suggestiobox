...
import { MixcloudPlayer } from '@/components/jokebox/mixcloud-player';
                ...
                <Card className="w-full max-w-2xl mx-auto overflow-hidden">
                    <div className="relative w-full h-48">
                        ...
                        <div className="absolute bottom-0 left-0 p-6">
                            <CardTitle className="text-3xl font-bold">Mixcloud Jukebox</CardTitle>
                            <CardDescription>Search for and play mixes from Mixcloud.</CardDescription>
                        </div>
                    </div>
