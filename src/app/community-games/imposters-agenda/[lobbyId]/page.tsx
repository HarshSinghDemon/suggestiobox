...
export default function ImposterLobbyPage({ params }: { params: { lobbyId: string } }) {
    const { user } = useUser();
    ...
    const lobbyRef = useMemoFirebase(() => {
        ...
        return doc(firestore, 'imposterLobbies', params.lobbyId);
        ...
        return (
            <AuthWrapper>
                 <div className="container py-8 mx-auto text-center">
                    ...
                    <Button onClick={() => router.push('/community-games/imposters-agenda')} className="mt-4">
                        Back to Game Hub
                    </Button>
                </div>
            </AuthWrapper>
                ...
                <div className="max-w-4xl mx-auto">
                    <Card>
                        <CardHeader className="text-center">
                            ...
                            <CardDescription>Share this code with friends to join the lobby. (Min 4 players to start)</CardDescription>
