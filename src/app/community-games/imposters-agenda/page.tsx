...
export default function ImpostersAgendaPage() {
    const { user } = useUser();
    ...
    const handleCreateLobby = async () => {
        ...
        try {
            ...
            const docRef = await addDoc(collection(firestore, 'imposterLobbies'), lobbyData);
            router.push(`/community-games/imposters-agenda/${docRef.id}`);
        } catch (error) {
    ...
    const handleJoinLobby = async () => {
        ...
        try {
            const q = query(collection(firestore, 'imposterLobbies'), where('joinCode', '==', joinCode.toUpperCase()));
            ...
            router.push(`/community-games/imposters-agenda/${lobbyId}`);
        ...
        <AuthWrapper>
            <div className="container py-12 mx-auto">
                <div className="max-w-md mx-auto text-center">
                    ...
                    <h1 className="text-4xl font-bold">Imposter's Agenda</h1>
