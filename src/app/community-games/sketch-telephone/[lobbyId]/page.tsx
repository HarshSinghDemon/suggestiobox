...
export default function SketchLobbyPage({ params }: { params: { lobbyId: string } }) {
    const { user } = useUser();
    ...
    const lobbyRef = useMemoFirebase(() => {
        ...
        return doc(firestore, 'sketchLobbies', params.lobbyId);
        ...
        return (
            <AuthWrapper>
                 <div className="container py-8 mx-auto text-center">
                    ...
                    <Button onClick={() => router.push('/community-games/sketch-telephone')} className="mt-4">
                        Back to Game Hub
                    </Button>
                </div>
            </AuthWrapper>
                ...
                <div className="max-w-4xl mx-auto">
                    <Card>
                        <CardHeader className="text-center">
                            ...
                            <CardDescription>Share this code with friends to join. (Min 3 players to start)</CardDescription>
                        ...
                        <CardContent>
                            ...
                            <div>
                                <h3 className="mb-4 text-xl font-semibold text-center">Players ({lobby.players.length} / 12)</h3>
