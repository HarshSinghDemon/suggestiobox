...
export default function SpyfallLobbyPage({ params }: { params: { lobbyId: string } }) {
    const { user } = useUser();
    ...
    const lobbyRef = useMemoFirebase(() => {
        ...
        return doc(firestore, 'spyfallLobbies', params.lobbyId);
        ...
        return (
            <AuthWrapper>
                 <div className="container py-8 mx-auto text-center">
                    ...
                    <Button onClick={() => router.push('/community-games/spyfall')} className="mt-4">
                        Back to Game Hub
                    </Button>
                </div>
            </AuthWrapper>
                ...
                <div className="max-w-4xl mx-auto">
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <div>
                                <h3 className="mb-4 text-xl font-semibold text-center">Players ({lobby.players.length} / 8)</h3>
                                <div className="grid grid-cols-2 gap-4 md:grid-cols-4 lg:grid-cols-5">
