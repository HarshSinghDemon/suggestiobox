...
export default function QuizLobbyPage({ params }: { params: { lobbyId: string } }) {
    const { user } = useUser();
    ...
    const lobbyRef = useMemoFirebase(() => {
        ...
        return doc(firestore, 'quizLobbies', params.lobbyId);
        ...
        return (
            <AuthWrapper>
                 <div className="container py-8 mx-auto text-center">
                    ...
                    <Button onClick={() => router.push('/community-games/quiz-royale')} className="mt-4">
                        Back to Quiz Royale
                    </Button>
                </div>
            </AuthWrapper>
                ...
                <div className="max-w-2xl mx-auto">
                    <Card>
                        <CardHeader className="text-center">
                            <CardTitle className="text-3xl">Quiz Royale Lobby</CardTitle>
                        ...
                        <CardContent>
                            ...
                            <div>
                                <h3 className="mb-4 text-xl font-semibold text-center">Players ({lobby.players.length})</h3>
                                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
